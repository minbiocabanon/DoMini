<?PHP
	...
	include('./planning/Planning_mois.php');
 ...
 <body>
	...
	<div class="float">
		<ul>
			...
			<li><a href="planning-mois.php" class="buttonside_current">Mois</a></li>
	...
	<div id="planning" align="center">
		...
		<?php
			...
			// TEST
			$contenusCellules[] = new PlanningCellule(2,1,2,4,'#111111', 10);
			
			// on génére le tableau de la semaine
			$planning = new Planning(0, 11, 1, 31, 1, $contenusCellules);
			// on affiche la table
