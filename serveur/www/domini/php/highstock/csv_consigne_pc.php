<?php // content="text/plain; charset=utf-8"
	...
	$SQL="SELECT DATE_FORMAT(date_time, '%d-%m-%Y') AS DATE, DATE_FORMAT(date_time, '%H:%i:%s') AS Heure, consigne
		FROM bypass_pc_log
		ORDER BY date_time"; 
	...
	//on ferme le fichier
	fclose($fp);		 
	echo"CSV consigne_pc exporté.<br>";
