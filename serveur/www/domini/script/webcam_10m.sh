...
# capture l'image de la webcam ???, sortie sous le nom test.jpg
wget -O ./test.jpg "http://192.168.0.121:88/cgi-bin/CGIProxy.fcgi?usr=user&pwd=user&cmd=snapPicture2"
