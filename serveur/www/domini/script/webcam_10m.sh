...
/usr/local/bin/ffmpeg -y -rtsp_transport tcp -i 'rtsp://192.168.0.119:554/live0.264' -f singlejpeg -vframes 1 garage.jpg

# capture l'image jardin/terrasse
echo capture ffmpeg 192.168.0.120:554/live0.264
/usr/local/bin/ffmpeg -y -rtsp_transport tcp -i 'rtsp://192.168.0.120:554/live0.264' -f singlejpeg -vframes 1 ext.jpg
...
/usr/local/bin/ffmpeg -y -rtsp_transport tcp -i 'rtsp://192.168.0.129:554/live0.264' -f singlejpeg -vframes 1 porche.jpg
