...
<head>
	...
	<title>DoMini - Air ext. + Air neuf + position bypass PC</title>
		<meta charset="UTF-8">	
		...
		<script type="text/javascript">
		    $(function ()
		    {
					var seriesOptions = [],
					seriesCounter = 0,
					names = ['temp_ext', 'temp_air_neuf','consigne_pc'];
							...
							$.get('./csv/' + name + '.csv', function (csv, state, xhr)
							{
								...
								switch (name)
								{
									...
									case 'temp_air_neuf':
										axe = 0;
										style_dashStyle = 'ShortDash';
										seriename = 'T° Air neuf';
										//seriecolor = '#89A54E';
										break;
									case 'consigne_pc':
										axe = 1;
										style_dashStyle = 'Solid';
										seriename = 'Consigne PC';
				...
				function createChart()
				{
					chart = new Highcharts.StockChart(
					{
						...
						// Deuxième axe puissance_pc
						{
							...
							align : 'right',
							gridLineWidth: 0,
							title: { text: 'Consigne PC', style: { color: '#55BF3B'}},
				...
				<div class="navbar">
				  <div class="navbar-inner">
					...
					<ul class="nav">
						...
						<li class="active"><a href="ventilation_air_neuf.php">Air neuf</a></li>
					</ul>
				  </div>
				</div>
