...
CREATE TABLE `VMC` (
  ...
  `tag` int(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=710282 DEFAULT CHARSET=latin1 COMMENT='Temperature VMCDF';
...
) ENGINE=MyISAM AUTO_INCREMENT=920536 DEFAULT CHARSET=latin1 COMMENT='Données T° + H° + Pt rosée Extérieures';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `analog2` (
  ...
  PRIMARY KEY (`id`),
  KEY `date_time` (`date_time`)
) ENGINE=MyISAM AUTO_INCREMENT=1001721 DEFAULT CHARSET=latin1 COMMENT='Données T° + H° + Pt rosée Intérieures';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `analog3` (
  ...
  PRIMARY KEY (`id`),
  KEY `date_time` (`date_time`)
) ENGINE=MyISAM AUTO_INCREMENT=968558 DEFAULT CHARSET=latin1 COMMENT='Données T° + H° + Pt rosée Puits Canadien';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `analog4` (
  ...
  `tag` int(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=303065 DEFAULT CHARSET=latin1 COMMENT='Sonde sortie bouche insufflation';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `analog5` (
  ...
  `tag` int(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=143366 DEFAULT CHARSET=latin1 COMMENT='Sonde dans les combles';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `analog6` (
  ...
  `tag` int(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=291058 DEFAULT CHARSET=latin1 COMMENT='Sondes autour de la VMCDF';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `bypass_pc_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=213049 DEFAULT CHARSET=latin1 COMMENT='log des consignes envoyées au bypass du puitscanadien';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `chauffage_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=356393 DEFAULT CHARSET=latin1 COMMENT='Table pour le log des consignes chauffage calculées par le r';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pellets` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1264 DEFAULT CHARSET=latin1 COMMENT='Données stock et consommation de sacs de granulés';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pyranometre` (
  ...
  PRIMARY KEY (`id`),
  KEY `date_time` (`date_time`)
) ENGINE=MyISAM AUTO_INCREMENT=778519 DEFAULT CHARSET=latin1 COMMENT='Données du pyranometre';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `teleinfo` (
  ...
  KEY `id` (`id`),
  KEY `date_time` (`date_time`)
) ENGINE=MyISAM AUTO_INCREMENT=18331023 DEFAULT CHARSET=latin1 COMMENT='Données du compteur EDF';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tx_msg_radio` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=904853 DEFAULT CHARSET=latin1 COMMENT='Table servant de pile des messages à émettre vers la radio (';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ups` (
  ...
  `tag` int(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=127851 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `voletroulant_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=125944 DEFAULT CHARSET=latin1 COMMENT='log pour voir l''évolution des volets';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-12-26  0:00:03
