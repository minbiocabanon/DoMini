...
CREATE TABLE `VMC` (
  ...
  `tag` int(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=129963 DEFAULT CHARSET=latin1 COMMENT='Temperature VMCDF';
...
) ENGINE=MyISAM AUTO_INCREMENT=315850 DEFAULT CHARSET=latin1 COMMENT='Données T° + H° + Pt rosée Extérieures';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `analog2` (
  ...
  PRIMARY KEY (`id`),
  KEY `date_time` (`date_time`)
) ENGINE=MyISAM AUTO_INCREMENT=323788 DEFAULT CHARSET=latin1 COMMENT='Données T° + H° + Pt rosée Intérieures';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `analog3` (
  ...
  PRIMARY KEY (`id`),
  KEY `date_time` (`date_time`)
) ENGINE=MyISAM AUTO_INCREMENT=307532 DEFAULT CHARSET=latin1 COMMENT='Données T° + H° + Pt rosée Puits Canadien';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `analog4` (
  ...
  `tag` int(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=95920 DEFAULT CHARSET=latin1 COMMENT='Sonde sortie bouche insufflation';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `analog5` (
  ...
  `tag` int(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=32627 DEFAULT CHARSET=latin1 COMMENT='Sonde dans les combles';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `analog6` (
  ...
  `tag` int(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=64799 DEFAULT CHARSET=latin1 COMMENT='Sondes autour de la VMCDF';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `bypass_pc_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=21237 DEFAULT CHARSET=latin1 COMMENT='log des consignes envoyées au bypass du puitscanadien';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pyranometre` (
  ...
  PRIMARY KEY (`id`),
  KEY `date_time` (`date_time`)
) ENGINE=MyISAM AUTO_INCREMENT=175957 DEFAULT CHARSET=latin1 COMMENT='Données du pyranometre';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `teleinfo` (
  ...
  KEY `id` (`id`),
  KEY `date_time` (`date_time`)
) ENGINE=MyISAM AUTO_INCREMENT=5695755 DEFAULT CHARSET=latin1 COMMENT='Données du compteur EDF';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tx_msg_radio` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=53 DEFAULT CHARSET=latin1 COMMENT='Table servant de pile des messages à émettre vers la radio (';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `voletroulant_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=56654 DEFAULT CHARSET=latin1 COMMENT='log pour voir l''évolution des volets';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2014-08-09  9:10:36
